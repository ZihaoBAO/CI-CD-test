...
const repoDir = 'C:/Efrei Paris/S8/DevOps and MLOps/assignment/4/project'; // this is where the code will pll your directory code locally just to use the docker-compose.yml file
const repoUrl = 'https://github.com/ZihaoBAO/CI-CD-test.git';// this is the url of the repo you want to pull the code from
